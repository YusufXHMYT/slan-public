...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .addField('Sunucu burada tanıtıldı! (https://discord.gg/VvAeCFCF6V).')
  .addField('12 saat Sonra sunucunuzu Tekrardan Tanıtabilirsiniz.')
  .addField('Sunucunu tanıtabilmek için beni ekle! (https://discord.com/api/oauth2/authorize?client_id=772825996394758154&permissions=8&scope=bot)')
  .setColor('GREEN')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('773428072937947177').send(embed)
            });
  ...
  message.channel.send({embed: {
      description: '**BAŞARISIZ TANITIM**:sparkles:  \n\nBu komut zaten kullanılmış!\n\nSunucunu 12 saate 1 defa tanıtabilirsin! :flag_tr:  \n\n[DESTEK SUNUCUM](https://discord.gg/VvAeCFCF6V) \n[Beni Sunucuna Ekleyebilmek İçin Tıklaman Yeterli!](https://discord.com/api/oauth2/authorize?client_id=772825996394758154&permissions=8&scope=bot)'
            }});
  }
};
...
exports.conf = {
    enabled: true,
    guildOnly: false,
    aliases: ['sunucutanıt','sunucunutanıt','sunucu-tanıt','sunucunu-tanıt'],
    permLevel: 2,
}
